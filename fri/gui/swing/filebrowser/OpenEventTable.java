	...
	private void addRow(String patt, boolean isLeaf, int i)	{
		...
		if (isLeaf)	{
			...
			if ((pattAndCmd = FileExtensions.isJavaClass(patt)) != null)	{
				...
				model.setValueAt(new Boolean(true), i, OpenCommandList.LOOP_COLUMN);
				model.setValueAt(new Boolean(false), i, OpenCommandList.MONITOR_COLUMN);
			...
			if ((pattAndCmd = FileExtensions.isXML(lpatt)) != null)
			{
				model.setValueAt(pattAndCmd[1], i, OpenCommandList.COMMAND_COLUMN);
				model.setValueAt(pattAndCmd[0], i, OpenCommandList.PATTERN_COLUMN);
				model.setValueAt(new Boolean(false), i, OpenCommandList.LOOP_COLUMN);
				model.setValueAt(new Boolean(false), i, OpenCommandList.MONITOR_COLUMN);
...
//			}
					...
					OS.isWindows && lpatt.endsWith(".bat"))
			{
				...
				model.setValueAt(new Boolean(true), i, OpenCommandList.LOOP_COLUMN);
				model.setValueAt(new Boolean(true), i, OpenCommandList.MONITOR_COLUMN);
			...
			model.setValueAt(new Boolean(true), i, OpenCommandList.LOOP_COLUMN);
			model.setValueAt(new Boolean(false), i, OpenCommandList.MONITOR_COLUMN);
			model.setValueAt(new Boolean(true), i, OpenCommandList.INVARIANT_COLUMN);
